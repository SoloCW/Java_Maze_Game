...
public class BasicRobotTest extends BasicRobot{
	...
	public void testContructor() {
		...
		assertTrue(basic.isForwardSensor());
		assertTrue(basic.isBackwardSensor());
		assertTrue(basic.isLeftSensor());
		assertTrue(basic.isRightSensor());
	...
	public void testRotateLeft() {
		...
		assertTrue(basic.getCurDir() == CardinalDirection.South);

	    basic.rotate(Turn.LEFT);
		assertTrue(basic.getCurDir() == CardinalDirection.West);

	    basic.rotate(Turn.LEFT);
		assertTrue(basic.getCurDir() == CardinalDirection.North);
		

	    basic.rotate(Turn.LEFT);
		assertTrue(basic.getCurDir() == CardinalDirection.East);
	}	
	@Test
	...
	public void testMoveCurEast(){
		mySetup();
		basic.setCurDir(CardinalDirection.East);
		basic.move(1, false);
		assertFalse(basic.isAtExit());
	}
	@Test
