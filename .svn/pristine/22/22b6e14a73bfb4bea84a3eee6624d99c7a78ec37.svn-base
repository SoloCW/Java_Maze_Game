...
public class SimpleKeyListener implements KeyListener {
	...
	SimpleKeyListener(Container parent, MazeController driver){
		this.parent = parent;
	...
	public void keyPressed(KeyEvent arg0) {
		...
		if( uikey == UserInput.Up || uikey == UserInput.Left || uikey == UserInput.Right) {
			switch(uikey) {
			case Up:
				controller.driver.moveRobot();
				break;
			case Left:
				controller.driver.rotateRobotLeft();
				break;
			case Right:
				controller.driver.rotateRobotRight();
				break;
